...
do
	...
	then
		...
		cdo -$operator -sellonlatbox,0,60,30,60 -seltimestep,916/1519 ../00001/${var}_00001.nc ${var}_EU.nc
		cdo -$operator -sellonlatbox,60,120,30,60 -seltimestep,916/1519 ../00001/${var}_00001.nc ${var}_AS.nc
		cdo -$operator -sellonlatbox,-120,-60,30,60 -seltimestep,916/1519 ../00001/${var}_00001.nc ${var}_NA.nc
	else
		rm -rf tmp
		for x in {4..7}
		do
